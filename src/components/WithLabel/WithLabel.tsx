...
import React, {
  FC, useState, ReactNode, FocusEvent, CSSProperties, memo, ComponentType,
} from 'react'
...
export const WithLabel = (component = 'input') => (WrappedComponent: ComponentType<any>): ReactNode => {
  const Label: FC<IFormikUiLabelProps> = props => {
    ...
    return (
      <div className={cx('form-element', component, { hasError: !!error, hidden })}>
        <div
